...
const createBooking = async (data: Booking): Promise<Booking> => {
  ...
  //     <p>We are thrilled to inform you that your event booking has been successfully confirmed! Thank you for choosing Eventify to be a part of your special day.</p>
  //     <h3>Event Details:</h3>
  ...
  //     <p>Please keep this email as a reference for your booking. If you have any questions or need to make any changes, don't hesitate to contact our customer support team at contact@eventify.com.</p>
...
const updateBooking = async (
  ...
  if (data.status && result.id) {
    if (
      ...
      <p> <strong>Dear ${result.user?.firstName}</strong> ,</p>
      <p>We are writing to inform you that the status of your event booking has been updated to <strong>${result.status}</strong>! Thank you for choosing Eventify to be a part of your special day.</p>
      <h3>Event Details:</h3>
      <p><strong>Event Name:</strong> ${result.event?.title}</p>
      ...
      <p> <strong>Dear ${result.user?.firstName}</strong> ,</p>
      <p>We are sorry to inform you that your event booking has been cancelled! Thank you for choosing Eventify to be a part of your special day.</p>
      <h3>Event Details:</h3>
      <p><strong>Event Name:</strong> ${result.event?.title}</p>
      <p><strong>Date:</strong>: From ${result.startDate} to ${result.endDate} </p>
      <p><strong>Location:</strong>: ${result.event?.location}</p>
